      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
            ...
            <span className="block mt-2">menggunakan alat kami</span>
          </h1>
          ...
          >
            Teknologi mutakhir yang menyediakan sistem peringatan dini ke daratan saat kapal mengalami kondisi darurat atau terbalik, memastikan respons cepat untuk keselamatan pelayaran.
          </motion.p>
